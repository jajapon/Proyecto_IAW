                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <textarea class="form-control" name="addComment" id="addComment" rows="5" required="required"></textarea>
                                           <input id="codprod" name="codprod" value="<?php echo $_POST["codprod"]; ?>" type="hidden" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group" style="position:relative;top:10px;">
                                        <div class="col-sm-offset-2 col-sm-10">                    
                                            <button class="btn btn-success btn-circle text-uppercase" type="submit" id="submitComment"><span class="glyphicon glyphicon-send"></span> Responder</button>
                                        </div>
                                    </div>            
                                </form>
                                <?php
                                    ...
                                    if ($connection->connect_errno) {
                                     ...
                                     if ($result = $connection->query($consulta)) {
                                            if ($result->num_rows==0) {
                                                ...
                                                if ($connection->query($consulta)) {
                                                   // header("Location: ./aproductos.php");
                                                    $ch = curl_init('./editarProducto.php');
                                                     curl_setopt ($ch, CURLOPT_POST, 1);
                                                     curl_setopt ($ch, CURLOPT_POSTFIELDS, "codprod=$prod");
                                                     curl_exec ($ch);
                                                     curl_close ($ch);
                                                 }else{
                                                     echo '<script language="javascript">
