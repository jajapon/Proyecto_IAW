               ...
               <nav id="nav" class="navbar-default navbar-inverse" role="navigation">
                ...
                <?php else: ?>
                      ...
                      <?php if ($_SESSION["rol"]=="User") : ?>
                        ...
                        <li ><a class="navbar-brand" href="#"><span class="glyphicon glyphicon-shopping-cart white"><p style="font-size:14px;position:relative;top:-3px;display:inline" "">
                        <?php
                                $connection = new mysqli("localhost","root","","phonejapan");
                                if ($connection->connect_errno) {
                        ...
                        <?php 
                            if(isset($_POST["usern"])){
                                ...
                                $connection = new mysqli("localhost", "root", "", "phonejapan");
                                    ...
                                    if ($result = $connection->query($consulta)) {
                                        if ($result->num_rows==0) {
                                            $consulta = "INSERT INTO USUARIO  VALUES (NULL,'$user', md5('$pass') ,'User' ,'ON','$correo','$nom','$ape','$dni','$fnac','$dir',$cp,'$ciudad','$prov','$pais',$tlf)";
