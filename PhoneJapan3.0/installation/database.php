...
(26, 15, 15, 50, '2016-01-15');");
  ...
  `TLF` int(9) DEFAULT NULL
    ...
    $connection->query("INSERT INTO `USUARIO` (`COD_USU`, `USERNAME`, `USERPASS`, `ROLE`, `ESTADO`, `EMAIL`, `NOMBRE`, `APELLIDOS`, `DNI`, `FECHA_NAC`, `DIRECCION`, `CP`, `CIUDAD`, `PROVINCIA`, `PAIS`, `TLF`) VALUES
...
(6, 'delasheras', '827ccb0eea8a706c4c34a16891f84e7b', 'User', 'ON', 'delasheras@gmail.com', 'Jose Daniel', 'De las Heras', '12345678D', '2016-01-07', 'lÃ±k,lÃ±klÃ±k', 77777, 'lkjkl', 'lkjkljl', 'ljkljkl', 645555666),
...
(11, 'ajvjimenez', '81dc9bdb52d04dc20036dbd8313ed055', 'User', 'ON', 'ajvjimenez@gmail.com', 'Antonio', 'Jimenez', '12345678D', '1991-01-15', 'C/ Alfareria 1ºB', 41010, 'Sevilla', 'Sevilla', 'EspaÃ±a', 999999999),
